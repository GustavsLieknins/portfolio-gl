...
const GITHUB_REPO_URL    = "https://github.com/GustavsLieknins/portfolio-gl";
    ...
    <>
      ...
      <header className="hero wrap">
        ...
        <motion.div className="actions" initial={{opacity:0,y:8}} animate={{opacity:1,y:0}} transition={{duration:.5,delay:.15}}>
          ...
          <a href={GITHUB_URL} className="btn github" target="_blank" rel="noopener noreferrer">
        ...
        >
          <svg className="icon" viewBox="0 0 16 16" aria-hidden="true" width="16" height="16">
